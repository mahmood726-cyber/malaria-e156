"""Import-smoke + pure-function tests for malaria-e156 (Bucket-B no-tests remediation).
...
def _load():
    ...
    spec = importlib.util.spec_from_file_location("buildmod_malaria_e156", _SCRIPT)
